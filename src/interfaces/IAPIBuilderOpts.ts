 ...
 * —————————————————————————————————————————————————————————————————————————————
 * File Path				— /src/interfaces/IAPIBuilderOpts.ts
 * File Created			— 2022-06-17 @ 07:18:20-05:00
 * Last Modified		— 2022-06-17 @ 07:18:23-05:00
...
export interface IAPIBuilderOpts {
